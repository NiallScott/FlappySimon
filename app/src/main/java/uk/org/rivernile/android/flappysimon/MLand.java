...
package uk.org.rivernile.android.flappysimon;
...
public class MLand extends FrameLayout {
    ...
    private static class Player extends ImageView implements GameView {
        ...
        private void setScore(int score) {
            mScore = score;
            if (mScoreField != null) {
                mScoreField.setText(DEBUG_IDDQD ? "??" :
                        getContext().getResources().getQuantityString(R.plurals.score_description,
                                score, score));
            }
        }
        ...
        public Player(Context context) {
            ...
            setBackgroundResource(R.drawable.simon);
